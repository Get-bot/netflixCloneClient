...
import SignInBtn from "../UI/SignIn/SignIn";
import classes from "./Header.module.css";

import {authAction, selectAuthUser} from "../../features/auth/authSlice";
            ...
            <div className={classes.logoWrapper}>
              <NavLink to={"/"}>
                    <span className={classes.logo} >
                        <svg viewBox="0 0 111 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className={classes.svgIcon}>
                        ...
                        <span className={classes.logoText}>넷플릭스</span>
                    </span>
              </NavLink>
            </div>
            <div className={classes.navContainer}>
              <div className={classes.navInner}>
                <div className={classes.navSelectorContainer}>
                  <LanguageSelect id={"lang-select"} className={""}/>
                  {!authUser && <SignInBtn/>}
                </div>
              </div>
            </div>
